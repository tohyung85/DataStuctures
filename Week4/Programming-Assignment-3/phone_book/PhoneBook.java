...
public class PhoneBook {
    ...
    private String[] directContacts = new String[100000000];

    private int prime = 100000007; //smallest prime > 10^8
    ...
    private void processQueryFast(Query query) {
        if(query.type.equals("add")) {
            directContacts[query.number] = query.name;
        }

        if(query.type.equals("del")) {
            directContacts[query.number] = "not found";
        }

        if(query.type.equals("find")) {
            writeResponse(directContacts[query.number]);
        }
    }
